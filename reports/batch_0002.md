...
| runtime | 267.0s |
| engine tests | 76 passed in 25.14s |
| generated | 2026-09-19 05:31:16 |
...
| AP-cost ability usage 40-70% of affordable rounds | 20/26 abilities outside the band; roster mean 26.0%; 1 champions >15pp from it | **FAIL** |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ashwyn | 88.0 [82.8, 91.8] | 200 | 7.80 | 4.07 | 1% | 82% | 0% | 13% | 1.78 | 1.53 | 2.8 | 0.3 | 46% | ionian_charmx200, long_swordx200, longbowx200 |
...
| mossgrove | 51.0 [44.1, 57.8] | 200 | 0.55 | 0.29 | 14% | 20% | 7% | 28% | 0.34 | 1.16 | 2.2 | 4.5 | 4% | ruby_crystalx198, long_swordx197, vampiric_bladex159 |
...
| lumen | 42.0 [35.4, 48.9] | 200 | 0.33 | 0.17 | 47% | 5% | 3% | 22% | 0.24 | 0.73 | 1.5 | 2.2 | 3% | ruby_crystalx200, longbowx198, bootsx170 |
...
- priority win rate: 50.0% [45.1, 54.9]
- north win rate: 46.0% [39.2, 52.9]
- length histogram: {8: 1, 9: 2, 10: 2, 11: 7, 12: 22, 13: 36, 14: 27, 15: 28, 16: 31, 17: 21, 18: 12, 19: 7, 20: 4}

## 6. Objectives

- takes per game: {'dragon': 2.025, 'baron': 0.94}
- median round taken: dragon 9, baron 11.0
- win rate when secured: {'dragon': 57.03703703703704, 'baron': 58.51063829787234}
- camp clears per game: {'wolves': 8.895, 'krugs': 9.62, 'raptors': 9.56, 'blue_buff': 5.26, 'red_buff': 5.455, 'dragon': 2.025, 'baron': 0.94}
...
| cloth_armor | 5 | 1.61 | 73.2% | 28.3% | +44.9 |
...
| vampiric_blade | 5 | 1.73 | 66.7% | 28.2% | +38.5 |
...
1. **economy outlier: ashwyn** - 7.80 AP/round = 4.07x roster mean
