...
SCHEMAS = {
    ...
    "judge": OBJ({"overall": INT, "engagement": INT, "coherence": INT, "spotlight_fairness": INT, "player_agency": INT,
                  ...
                  "backstory": ARR(OBJ({"name": STR, "world_driven": BOOL, "world_driven_events": INT,
                                        "player_raised": BOOL, "score": INT, "note": STR},
                                       ["name", "world_driven", "world_driven_events", "player_raised", "score"])),
