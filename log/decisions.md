...
| id | ruling | status |
|---|---|---|
| RQ-045 | **An AREA is a radius-1 disc around a centre the player places within the step's range; Longbow extends where the centre may be placed, not the blast.** The engine had implemented AREA as a disc of radius `range` centred on the champion, and Longbow's +1 made every range-1 AREA a 19-hex blast. Implemented as P-0012, config `area_center`. Read in batch_0050 against batch_0048: every engine's income down about a third, pallas back to the mean, sable/wisp/ashwyn/quillan still 1.6-1.9x - a 1-AP AREA on a 1-round cooldown that hits one wave a round is still the roster's best income. | ruled, implemented, partial |
| RQ-038 (follow-up) | **Tower HP comes down under the ruled economy - and the Nexus with it.** batch_0046: at tower HP 16, 1 Nexus kill in 120. batch_0048 (HP 8): 30% Nexus kills, first tower round 11. batch_0049 (HP 6): 49%, first tower round 8, median still 20. Towers now fall, but six towers plus a 12-HP Nexus on L0 and waves alone is more siege than 20 rounds hold. Second pass: tower 4 / Nexus 8, tower 4 / Nexus 12, tower 6 / Nexus 8 (batches 0051-0053), with the centred AREA. | in progress |
